...
if (isset($_POST['submit'])) {  
  ...
  $gender = $_POST['gender'];
  $email = $_POST['email'];
  $sql = mysqli_query($con, "Update users set fullName='$fullname', address='$add', city='$city', gender='$gender', email='$email' where id='$did'");
  if ($sql) {
                      ...
                      <div class="panel-body">
                        ...
                        <form role="form" name="adddoc" method="post" onSubmit="return valid();">
                          ...
                          <div class="form-group">
                            ...
                            <textarea name="add" class="form-control"><?php echo htmlentities($data['address']); ?></textarea>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <input type="text" name="email" class="form-control" required="required" value="<?php echo htmlentities($data['email']); ?>">
                          </div>
